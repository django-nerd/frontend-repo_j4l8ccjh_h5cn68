...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 md:pt-24 pb-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-6 md:gap-8 mt-8 text-blue-200/80 text-sm">
          ...
          >
            ...
            <div className="relative bg-slate-800/60 border border-white/10 rounded-3xl p-4 shadow-2xl">
              <div className="aspect-[9/19] w-72 sm:w-80 mx-auto rounded-[2rem] bg-black border border-white/10 overflow-hidden shadow-2xl">
                ...
                <div className="relative h-[520px] sm:h-[560px]">
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-3 text-white"
                  >
